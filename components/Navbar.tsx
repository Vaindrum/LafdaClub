      ...
      >
        ...
        <div className="hidden md:flex space-x-4">
          {authUser ? (
            <>
              <Link href="/cart">
                <button className="px-4 py-2 hover:text-pink-500 rounded transition cursor-pointer"><FaShoppingCart size={20} /></button>
              </Link>
              <Link href="/profile">
      ...
      >
        ...
        <div className="flex flex-col space-y-4 p-4 text-white text-base">
          ...
          <div className="flex flex-col border-t border-gray-700 pt-4 space-y-2">
            {authUser ? (
              <>
                <Link href={`/profile/${username}`} onClick={closeMenu} className="text-pink-500">
                  Profile
                </Link>
